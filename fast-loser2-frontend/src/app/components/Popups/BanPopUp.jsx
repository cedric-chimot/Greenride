...
const BanPopUp = (props) => {
  ...
  ////Stocke la date de fin de banissement dans un state sous forme de timestamp ou envoie un avertissement selon la valeur de props.theme////
  ...
  ////Envoi de la date de banissement dans la bdd////
  const banHandler = () => {
  ...
  ////Envoi d'un avertissement et effectue le banissement en fonction du nombre d'avertissements en bdd////
